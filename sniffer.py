#In Scapy, use the sniff() function to capture network packets.
...
stop_filter: python function applied to each packet to determine
             if have to stop the capture after this packet
...
#Also, when using setup (VirtualBox-to-GNS3), you should go to the Settings section for the virtual machine you are using...
